...
int main() {
    ...
    Holder* bp = ih3;
    Holder hres = std::reloc_and_uninitialize(bp);
...
// DoubleHolder()
// DoubleHolder dv=dv
// h1(h1 reloc) 0x13 <- 0x9
// h2(h2 reloc) 0x14 <- 0x10
// Holder(reloc)
// dv(dv reloc) 0x15 <- 0x11
// dw(dw reloc) 0x16 <- 0x12
// DoubleHolder(reloc)
// DoubleHolder dv=dv
...
// ~iw() 0x20
// ~iv() 0x19
// h1(h1 reloc) 0x21 <- 0x17
// h2(h2 reloc) 0x22 <- 0x18
// Holder(reloc)
// h1=h1 h2=h2
// Holder
// ---end---
