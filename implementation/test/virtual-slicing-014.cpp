...
// dynamic types through a common base pointer using std::reloc_and_uninitialize.
...
int main() {
    ...
    Dog dog2 = std::reloc_and_uninitialize(dog);
    std::cout << "dog relocated" << std::endl;
    Cat cat2 = std::reloc_and_uninitialize(cat);
