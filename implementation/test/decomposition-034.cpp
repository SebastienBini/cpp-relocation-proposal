/// Decompose a const derived object via a reloc parameter.
/// The const qualifier is stripped by reloc, then the friend function
/// decomposes the base subobject and passes it to sink_b.
